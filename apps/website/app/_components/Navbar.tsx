  ...
  return (
    ...
    >
      ...
      <div className="hidden md:flex items-center gap-6">
        <Link href="http://localhost:3002" className="text-sm text-slate-400 hover:text-white transition-colors no-underline">
          Docs
        </Link>
        <a
      ...
      <Link
        href="http://localhost:3002/docs/quick-start"
